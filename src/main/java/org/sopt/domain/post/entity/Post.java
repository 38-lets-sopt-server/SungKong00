...
public class Post {
    ...
    public Post(Long id, BoardType boardType, String title, String content, String author, LocalDateTime createdAt) {
        this.id = id;
    ...
    public Post(BoardType boardType, String title, String content, String author, LocalDateTime createdAt) {
        this.boardType = boardType;
        this.title = title;
        this.content = content;
        this.author = author;
